...
typedef enum
{
	...
	EDG_NEXTION_COMMAND_CHANGE_TEMPERATURE,
	EDG_NEXTION_COMMAND_SET_DATE,
	EDG_NEXTION_COMMAND_PASSWORD,
	EDG_NEXTION_COMMAND_SET_THERMOCOUPLES,
	EDG_NEXTION_COMMAND_LOAD_PROGRAM_VALUES,
	EDG_NEXTION_COMMAND_SAVE_PROGRAM_VALUES,
