...
EDG_NEXTION_StatusTypeDef EDG_NEXTION_StartReceiveFrame(EDG_NEXTION_HandleTypeDef * ptrhedgNextion)
{
	...
	/*** Clear Flags ***/
	if(__HAL_UART_GET_FLAG(&EDG_NEXTION_USART_PORT_HANDLE, UART_FLAG_ORE))
	{
		__HAL_UART_CLEAR_OREFLAG(&EDG_NEXTION_USART_PORT_HANDLE);
	}
	if(__HAL_UART_GET_FLAG(&EDG_NEXTION_USART_PORT_HANDLE, UART_FLAG_NE))
	{
		__HAL_UART_CLEAR_NEFLAG(&EDG_NEXTION_USART_PORT_HANDLE);
	}
	if(__HAL_UART_GET_FLAG(&EDG_NEXTION_USART_PORT_HANDLE, UART_FLAG_FE))
	{
